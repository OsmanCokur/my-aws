...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstonedb.ca2dpdth8tlc.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'capstone-media-cokur' # please enter your s3 bucket name
